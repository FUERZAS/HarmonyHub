document.addEventListener('DOMContentLoaded', function() {
    ...
    if (sidebarToggle) {
        sidebarToggle.addEventListener('click', function(e) {
            e.stopPropagation();
            console.log('[DEBUG] sidebarToggle clicked - before toggle:', sidebar.classList.contains('mobile-collapsed'));
            sidebar.classList.toggle('mobile-collapsed');
            console.log('[DEBUG] sidebarToggle clicked - after toggle:', sidebar.classList.contains('mobile-collapsed'));
            updateToggleIcon();
        });
    }
    ...
    function updateToggleIcon() {
        if (window.innerWidth <= 1024) {
            ...
            sidebarToggle.innerHTML = isCollapsed ? '<i class="fas fa-times"></i>' : '<i class="fas fa-bars"></i>';
            console.log('[DEBUG] updateToggleIcon called - isCollapsed:', isCollapsed, 'innerHTML set to:', sidebarToggle.innerHTML);
        }
    }
});
